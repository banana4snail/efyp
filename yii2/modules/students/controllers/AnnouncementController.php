...
use Yii;
use app\modules\students\models\Announcement;
use app\modules\students\models\AnnoucementSearchn;
...
class AnnouncementController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index','view','create','update','delete','view-announcement'],
                        'roles' => ['manageAnnouncement'],
                    ],
                    [
                        'allow' => true,
                        'actions' => ['view-announcement'],
    ...
    {
        $searchModel = new AnnoucementSearchn();
    ...
    public function actionViewAnnouncement()
    {
        ...
        return $this->render('view-announcement',['announcement'=>$announcement]);
